...
// rungs · finale. Pricing is OFF the home journey now — it lives only on /pricing.
const TRUST = COPY.trust.rungs
const FRAMES = 4 + TRUST.length + 1 // hero,draw,clan,arsenal + trust + finale (no pricing on home)
const ARSENAL = 3
