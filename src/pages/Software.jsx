...
.pg-software-prob::before{
  ...
  box-shadow:inset 0 0 60px rgba(227,74,39,0.12);
...
.pg-software-step-node{
  ...
  box-shadow:6px 6px 0 rgba(0,0,0,0.5), inset 0 0 30px rgba(227,74,39,0.1);
...
.pg-software-proof{
  ...
  background:
    radial-gradient(120% 90% at 50% 0%, rgba(227,74,39,0.08), transparent 62%),
    rgba(13,15,20,0.6);
  box-shadow:8px 8px 0 rgba(0,0,0,0.6), inset 0 0 80px rgba(227,74,39,0.06);
}
.pg-software-proof-crest{
  ...
  display:block; filter:drop-shadow(0 0 12px rgba(232,93,4,0.4));
}
...
.pg-software-proof-link{
  ...
  border-bottom:1.5px solid rgba(232,93,4,0.5); padding-bottom:3px;
...
.pg-software-price-num{
  ...
  color:var(--gw-ember); text-shadow:0 0 32px rgba(232,93,4,0.45), 0 2px 10px rgba(0,0,0,0.6);
}
.pg-software-terms{
