        ...
        <div className="pg-auto-unify">
          <svg className="pg-auto-unify-svg" viewBox="0 0 360 220" role="img"
            ...
            <g className="pg-auto-u-core">
              ...
              <rect x="286" y="78" width="64" height="64" fill="#74D3E8" opacity="0.08" />
              <path d="M318 92 l18 12 v20 l-18 12 -18-12 v-20 z" fill="none" stroke="#74D3E8" strokeWidth="1.5" />
              <circle cx="318" cy="114" r="4" fill="#74D3E8" />
            </g>
        ...
        <div className="pg-auto-vs">
          ...
          <div className="pg-auto-vs-arrow" aria-hidden="true">
            <svg viewBox="0 0 64 24" role="presentation">
              <path d="M2 12 H56" fill="none" stroke="#74D3E8" strokeWidth="2" />
              <path d="M48 5 L60 12 L48 19" fill="none" stroke="#74D3E8" strokeWidth="2" />
            </svg>
          </div>
...
.pg-auto-own li::before{content:""; position:absolute; left:0; top:0.55em; width:9px; height:9px;
  background:var(--gw-ember); box-shadow:0 0 10px rgba(116,211,232,0.6);}
...
.pg-auto-proc-n{font-family:var(--gw-display); font-weight:900; line-height:0.85;
  font-size:clamp(2rem,5vw,2.9rem); color:rgba(116,211,232,0.85); min-width:1.6em;}
...
.pg-auto-price-num{font-family:var(--gw-display); font-weight:900; line-height:0.9;
  ...
  text-shadow:0 0 28px rgba(116,211,232,0.4);}
