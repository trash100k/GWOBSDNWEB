      ...
      <style>{`
        ...
        .pg-web-card--forge{border-color:rgba(193,41,46,0.7); background:rgba(28,16,14,0.5);
          box-shadow:8px 8px 0 rgba(0,0,0,0.6),
            inset 0 0 60px rgba(227,74,39,0.1);}
        ...
        .pg-web-pillar:hover{border-color:rgba(232,93,4,0.7); transform:translate(-2px,-2px);
          box-shadow:10px 10px 0 rgba(0,0,0,0.6), inset 0 0 50px rgba(227,74,39,0.08);}
        ...
        .pg-web-tier--flagship{border-color:rgba(193,41,46,0.7);
          ...
          box-shadow:8px 8px 0 rgba(0,0,0,0.62), inset 0 0 70px rgba(227,74,39,0.1);}
        ...
        .pg-web-tier--flagship .pg-web-tier-price{color:var(--gw-ember);
          text-shadow:0 0 30px rgba(232,93,4,0.4);}
        ...
        @media (max-width:720px){
          ...
          .pg-web-card--forge{box-shadow:6px 6px 0 rgba(0,0,0,0.6), inset 0 0 60px rgba(227,74,39,0.1);}
